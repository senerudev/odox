        ...
        <div class="vd_content clearfix">
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-xs-6 text-right">
                            <div class=""> <a href="#" style="color: #009beb">Forget Password? </a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Panel Widget -->
              <div class="register-panel text-center font-semibold"> <a href="register.php" style="color: #009beb">CREATE AN ACCOUNT<span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a> </div>
            </div>
            <!-- vd_login-page --> 
